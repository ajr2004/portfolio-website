        ...
        <div className="max-w-7xl mx-auto px-6 py-4 flex justify-between items-center">
          ...
          <ul className="hidden md:flex gap-8 text-xs font-bold uppercase tracking-widest items-center">
            ...
            <li>
              ...
              <a href="YOUR_RESUME_LINK" target="_blank" rel="noopener noreferrer" className="bg-green-400 text-black px-4 py-2 rounded-sm hover:bg-white transition-colors">Resume</a>
            </li>
          </ul>
